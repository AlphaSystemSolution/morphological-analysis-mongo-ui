 ...
 * @author sali
 */
public class AbstractTerminalNodeAdapter<N extends TerminalNode> extends LineSupportAdapter<N> {
    ...
    public AbstractTerminalNodeAdapter() {
        super();
    ...
    @Override
    protected void initValues(N terminalNode) {
