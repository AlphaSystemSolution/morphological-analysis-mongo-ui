 ...
 * @author sali
 */
public class RelationshipControlPropertiesEditor extends PropertiesEditor<RelationshipNode, RelationshipNodeAdapter> {
    ...
    public RelationshipControlPropertiesEditor() {
        super();
